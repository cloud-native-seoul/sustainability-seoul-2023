  ...
  return (
    <>
      <h3 className={styles.picturesTitle}>
        <FormattedMessage id="picturesTitle" />
      </h3>
      <div className={styles.pictures}>
        <Picture image={data.pic1} />
        <Picture image={data.pic2} />
        <Picture image={data.pic3} />
        <Picture image={data.pic4} />
        <Picture image={data.pic5} />
        <Picture image={data.pic6} />
      </div>
    </>
  );
}
